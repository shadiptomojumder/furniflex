...
import { ArrowLeftToLine, Boxes, icons, LayoutDashboard, LayoutList, PackagePlus, PanelLeftClose, PanelRightClose } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <div onClick={() => setShowSideBar(false)} className="mx-2 md:mb-20 mb-10">
